...
FRONTEND_ORIGINS=https://autofix-awarm.netlify.app
...
# Backend
cd "D:\Autofix Swarm"
vercel --prod --scope leak-logic-ai

# Frontend
cd "D:\Autofix Swarm\frontend"
...
FRONTEND_ORIGINS=http://localhost:3000,https://autofix-awarm.netlify.app
